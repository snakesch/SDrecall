...
3. Despite the relatively low precision rate, SDrecall's rigorous FP control managed to mitigate the amount of rare and deleterious FPs introduced by SDrecall. So that the expert review of molecular diagnosis wont be overwhelmed by the noises from SDrecall.
