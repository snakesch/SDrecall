...
def merge_var(pv_vcf, ov_vcf, pv_tag, ov_tag, keep_both) -> pd.DataFrame:
    """
...
@timing
def merge_all(pvcf, ovcf, outpath, pv_tag, ov_tag, keep_both):
    """
    ...
    merged_df = merge_var(pvcf, ovcf, pv_tag, ov_tag, keep_both)
...
if __name__ == "__main__":
    ...
    merge_all(args.pvcf, args.ovcf, args.outpath, args.pv_tag, args.ov_tag, args.keep_both)
