...
def preparation(ref_genome: str,
    ...
    # Step 6.5: Enumerate qnodes and cnodes in the graph. (FC -> qnode; NFC -> cnode), only for debugging
    ...
    nx.write_graphml(final_graph, final_graph_path) # save graph for debugging
